        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "aero",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api_app.aero"
                    ),
                ),
                (
                    "bumper",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api_app.bumper"
                    ),
                ),
                (
                    "color",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api_app.color"
                    ),
                ),
                (
                    "light",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api_app.light"
                    ),
                ),
                (
                    "user",
                ...
                (
                    "wheel",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api_app.wheel"
                    ),
                ),
            ],
        ),
